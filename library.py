...
def handle(obj):
    ...
    while True:
        ...
        if ch1==1:
            ...
            print('1.Add\n2.Remove\n3.ListBooks\n4.Search\n5.Display')
            print('-------------------------------')
            print(obj.add_book(input('Enter the book title:')))
        elif ch1==2:
            os.system('cls')
            print('-------------------------------')
            print('1.Add\n2.Remove\n3.ListBooks\n4.Search\n5.Display')
            print('-------------------------------')
            print(obj.remove_book(input('Enter the book title:')))
        elif ch1==3:
            os.system('cls')
            print('-------------------------------')
            print('1.Add\n2.Remove\n3.ListBooks\n4.Search\n5.Display')
            print('-------------------------------')
            l=obj.listBooks()
            print_slow('These are the Books')
            ...
            print('1.Add\n2.Remove\n3.ListBooks\n4.Search\n5.Display')
            print('-------------------------------')
            temp="👍" if obj.search_book(input('Enter the book title:')) else "😒"
            print(temp)
        elif ch1==5:
            os.system('cls')
            print('-------------------------------')
